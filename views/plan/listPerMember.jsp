...
<head>
    ...
    <script src="/planner/resources/js/plan/listPerMember.js"></script>
</head>
<body>
    <h1 class="h-emp"><%= empId %>님의 일정</h1>
    <!-- 일정 -->
        ...
        %>
                <div class="plan-box">
                    ...
                    <div class="plan-icon-group right">
                        <button type="button" value="upt" class="upt-btn hide">
                            <i class="fa-regular fa-pen-to-square plan-icon light-blue-icon"></i>
                        </button>
                        <button type="button" value="del" class="del-btn hide">
